...
VINS_MERGED_YOLO_SPLITS_IMAGES = f"{VINS_MERGED_YOLO_SPLITS}images/"
VINS_MERGED_YOLO_SPLIT_VAL_IMAGES = f"{VINS_MERGED_YOLO_SPLITS_IMAGES}validation/"
VINS_MERGED_YOLO_SPLIT_TRAIN_IMAGES = f"{VINS_MERGED_YOLO_SPLITS_IMAGES}/train/"
VINS_MERGED_YOLO_SPLIT_TEST_IMAGES = f"{VINS_MERGED_YOLO_SPLITS_IMAGES}/test/"
VINS_MERGED_YOLO_SPLITS_LABELS = f"{VINS_MERGED_YOLO_SPLITS}labels/"
VINS_MERGED_YOLO_SPLIT_VAL_LABELS = f"{VINS_MERGED_YOLO_SPLITS_LABELS}validation/"
VINS_MERGED_YOLO_SPLIT_TRAIN_LABELS = f"{VINS_MERGED_YOLO_SPLITS_LABELS}train/"
VINS_MERGED_YOLO_SPLIT_TEST_LABELS = f"{VINS_MERGED_YOLO_SPLITS_LABELS}test/"
# EditText -> InputField
